...
const layoutConfig = reactive({
    preset: import.meta.env.VITE_PRIME_PRESET || 'Lara',
    primary: import.meta.env.VITE_PRIME_PRIMARY || 'cyan',
    surface: import.meta.env.VITE_PRIME_SURFACE || 'slate',
...
export function useLayout() {
    ...
    const isDarkTheme =
        computed(() => layoutConfig.darkTheme);

    const isDesktop = () =>
        window.innerWidth > 991;

    const hasOpenOverlay =
        computed(() => layoutState.overlayMenuActive);
